...
INSERT INTO users (email, username, password, full_name, born, is_active, is_admin)
VALUES
    ('admin@example.com', 'admin', 'admin123', 'MyAdmin', '1990-01-01', TRUE, FALSE),
    ('test@example.com', 'test', 'test123', 'TestUser', '1990-01-01', TRUE, FALSE),
    ('alice@example.com', 'alice', 'alice123', 'TestAlice', '1990-01-01', TRUE, FALSE),
    ('bob@example.com', 'bob', 'bob123', 'TestBob', '1990-01-01', TRUE, FALSE),
    ('charlie@example.com', 'charlie', 'charlie123', 'TestCharlie', '1990-01-01', TRUE, FALSE)
